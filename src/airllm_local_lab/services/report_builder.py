...
from airllm_local_lab.services._report_figs import render_f5
...
def main() -> None:
    ...
    f5_caption, f5_blurb = render_f5(RESULTS)
    figs = {
        n: _fig(n, c)
        for n, c in [
            ...
            ("F5_layer_timeline.png", f5_caption),
    ...
    sections = [
        ...
        + f"\n{f5_blurb}{figs['F5_layer_timeline.png']}"
        + f"{figs['F6_page_cache_warmup.png']}{figs['F7_io_location.png']}",
        ...
        section_run_instructions(),
        section_contributing(),
        f"*Generated by `uv run report` · v{__version__} · 2026-06-20*",
    ]
